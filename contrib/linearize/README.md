# Linearize
Construct a linear, no-fork, best version of the GCC blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install TheGCCcoin_hash

https://github.com/TheGCCcoin/GCC_hash
...
JSON-RPC server. Running `TheGCCcoind` or `TheGCCcoin-qt -server` will be sufficient.
...
* `input`: TheGCCcoind blocks/ directory containing blkNNNNN.dat
