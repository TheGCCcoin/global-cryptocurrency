 ...
 *
 *   // network
 *   CGCCNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.TheGCCcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGCCNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: GCCNetwork
// //   -- signature requirements : Key1(User)
// class CGCCNetworkVariable : public CGovernanceObject
// {
// private:
