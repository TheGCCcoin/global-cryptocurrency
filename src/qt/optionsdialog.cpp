    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TheGCCcoin-light"), QVariant("light"));
    ui->theme->addItem(QString("TheGCCcoin-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("TheGCCcoin-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("TheGCCcoin-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("TheGCCcoin-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TheGCCcoin-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TheGCCcoin-traditional"), QVariant("trad"));
