    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("GCC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GCC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and TheGCCcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About GCC Core"), this);
    aboutAction->setStatusTip(tr("Show information about GCC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GCC Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GCC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GCC addresses"));
    ...
    openAction->setStatusTip(tr("Open a TheGCCcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GCC Core help message to get a list with possible GCC Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("GCC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GCC network", "", count));
}
...
{
    QString strTitle = tr("GCC Core"); // default title
