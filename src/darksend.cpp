...
{
    if(fLiteMode) return; // ignore all GCC related functionality
...
/*
    ...
    allow endless transaction that would bloat GCC and make it unusable. To
...
{
    if(fLiteMode) return; // disable all GCC specific functionality
    ...
    RenameThread("TheGCCcoin-privatesend");
