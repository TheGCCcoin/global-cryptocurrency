...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid TheGCCcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid TheGCCcoin address" in e.error['message'])
        ...
        # send 12 TheGCCcoin to msig addr
