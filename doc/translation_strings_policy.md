...
This document provides guidelines for internationalization of the GCC Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `TheGCCcoin_en.ts` remains unchanged.
