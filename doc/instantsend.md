...
This mechanism has been integrated into Bitcore-Node-GCC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/thegcccoinpay/insight-api-TheGCCcoin#web-socket-api](https://github.com/thegcccoinpay/insight-api-TheGCCcoin#web-socket-api)
* API: [https://github.com/thegcccoinpay/insight-api-TheGCCcoin#instantsend-transactions](https://github.com/thegcccoinpay/insight-api-TheGCCcoin#instantsend-transactions)
...
By default, the GCC Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GCC Core daemon:
