...
in the GCC Core repository under 'Fetch and create inputs' to install sources which require
...
```bash
    ...
    From https://github.com/TheGCCcoin/GCC
...
BTCPATH=/some/root/path/TheGCCcoin
SIGPATH=/some/root/path/TheGCCcoin-detached-sigs
