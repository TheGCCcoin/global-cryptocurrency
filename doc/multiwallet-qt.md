...
Only requiring some minor changes is TheGCCcoin.cpp.
...
Changes to TheGCCcoin.cpp
----------------------
TheGCCcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
