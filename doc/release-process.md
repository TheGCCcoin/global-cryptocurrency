...
* Update translations, see [translation_process.md](https://github.com/thegcccoinpay/TheGCCcoin/blob/master/doc/translation_process.md#syncing-with-transifex)
...
###Build and sign GCC Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit TheGCCcoin=v${VERSION} ../TheGCCcoin/contrib/gitian-descriptors/gitian-linux.yml
	...
	./bin/gbuild --commit TheGCCcoin=v${VERSION} ../TheGCCcoin/contrib/gitian-descriptors/gitian-win.yml
	...
	./bin/gbuild --commit TheGCCcoin=v${VERSION} ../TheGCCcoin/contrib/gitian-descriptors/gitian-osx.yml
...
###Verify other gitian builders signatures to your own. (Optional)
  ...
  Add other gitian builders keys to your gpg keyring
	...
	gpg --import ../TheGCCcoin/contrib/gitian-downloader/*.pgp
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [TheGCCcoin-detached-sigs](https://github.com/thegcccoinpay/TheGCCcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Update title of #thegcccoinpay on Freenode IRC

  - Optionally reddit /r/TheGCCcoinpay, ... but this will usually sort out itself
